...
Original file is located at
    https://colab.research.google.com/drive/19UHQIv0KB7RDaJKQ0PQy0t5B8J7OvDfC
"""
...
def get_data():
    with open("/content/drive/MyDrive/Jun 2023/sdp_act/train.txt", "r", encoding="utf-8") as fp:
        data = fp.readlines()
    return data[1:]

def get_test_data():
    with open("/content/drive/MyDrive/Jun 2023/sdp_act/test.txt", "r", encoding="utf-8") as fp:
        data = fp.readlines()
    return data[1:]
            ...
            for step, batch_data in enumerate(train_loader):
                ...
                if gloabl_step % self.args.eval_step == 0:
                    ...
                    if accuracy > best_acc:
                        ...
                        torch.save(self.model.state_dict(), "./drive/MyDrive/Colab Notebooks/output/bert_prompt.pt")
...
def main():
    ...
    ckpt_path = "./drive/MyDrive/Colab Notebooks/output/bert_prompt.pt"
    model = BertForMaskedLM.from_pretrained(args.model_path)
    model.load_state_dict(torch.load(ckpt_path, map_location="cpu"))
    model.to(args.device)
